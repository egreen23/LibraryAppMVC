...
namespace LibraryAppMVC.Migrations
{
    ...
    [Migration("20241122094014_AddReviewTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryAppMVC.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LibraryAppMVC.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryAppMVC.Models.Loan", b =>
                {
                    b.HasOne("LibraryAppMVC.Models.ApplicationUser", "User")
                        .WithMany("Loans")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LibraryAppMVC.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
